...
namespace Parugu
{
    ...
    void Editor::Initialize()
	{
       ...
       m_mesh = std::make_shared<Graphics::Mesh>(&verts[0], 4, 3, &elements[0], 6);
        ...
        m_shader = std::make_shared<Graphics::Shader>(vertShader, fragShader);
	...
	void Editor::Render()
	{
        auto rc = std::make_unique<Graphics::RenderCommands::RenderMesh>(m_mesh, m_shader);
